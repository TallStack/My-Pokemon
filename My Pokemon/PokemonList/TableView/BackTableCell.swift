...
class BackTableCell: UITableViewCell {
    ...
    var secondCellLabel = UILabel()
       ...
       override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
           super.init(style: style, reuseIdentifier: "BackTableCell")
           ...
           secondCellLabel.translatesAutoresizingMaskIntoConstraints = false
           secondCellLabel.font = UIFont.systemFont(ofSize: 20)
           contentView.addSubview(secondCellLabel)
           ...
           NSLayoutConstraint.activate([
               ...
               secondCellLabel.centerYAnchor.constraint(equalTo: contentView.centerYAnchor),
               secondCellLabel.leadingAnchor.constraint(equalTo: cellLabel.trailingAnchor, constant: 10),
    ...
    func configure(with viewModel: PokemonCellViewModel) {
        ...
        self.secondCellLabel.text = viewModel.id
